...
public partial class ProxiesList : UserControl
{
    public ProxiesList()
    {
        InitializeComponent();
        base.DataContext = new ProxiesListViewModel();
    ...
    private void ListItemsView_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        ((ProxiesListViewModel)base.DataContext).SelectedObjects = SelectedObjects;
    }
}
